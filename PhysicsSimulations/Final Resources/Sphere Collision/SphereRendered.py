...
class Sphere:
    def __init__(self, x, y, z, r, p): #x, y, z are the coordinates of the centre of the sphere, r is the radius, p is the precision (number of points in a semicircle). Minimum value of p is 2.
...
class Collision(ShowBase):
    def __init__(self):
        ...
        sphere0 = Sphere(20, 2, 20, 2, 8)#creates the sphere
