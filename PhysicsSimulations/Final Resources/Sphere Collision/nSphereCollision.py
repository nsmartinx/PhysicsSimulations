...
class Collision(ShowBase):
    def __init__(self):
        ...
        global spheres, clock, previousTime
        spheres = list()
        
        spheres.append(Sphere(20, 3, 20, 2, 8, 1))
        spheres.append(Sphere(-20, 0, 22, 2, 8, 1))
        spheres.append(Sphere(4, 1, 20, 2, 8, 1))
        
        spheres[0].velocity = (LVector3(-10, 0, 0))
        spheres[1].velocity = (LVector3(10, 0, 0))
